...
// Battery/temp sampling interval (ms); lower rate saves a little CPU/ADC without affecting radio.
#define PMU_UPDATE_INTERVAL_MS 2000
int pmu_update_interval = PMU_UPDATE_INTERVAL_MS;
